...
/**
 * print_magic_numbers - prints the magic number of an ELF header
 * @e_ident: a pointer to an array containing the ELF magic numbers
 *
 ...
 * @e_ident: a pointer to an array containg the ELF class
 */
...
/**
 * printf_elf_data - prints the data of an ELF header
...
/**
 * print_elf_osabi - prints the OS/ABI of an ELF version
 * @e_ident: a pointer to an array containing the ELF version
 */
...
/**
 * main - displays the information of an ELF header
